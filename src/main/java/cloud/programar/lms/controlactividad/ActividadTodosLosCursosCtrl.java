...
/**
 *
 * Controlador para obtener la actividad de todos los cursos existentes.
...
public class ActividadTodosLosCursosCtrl {
    ...
    public ModelAndView actividadTodosLosCursosHTML(
        ...
        ActividadCurso[] actividadCursos = {
            new ActividadCurso("cultura", "Cultura DevOps", 2580, desde, hasta),
            new ActividadCurso("apirest", "Diseño de APIs", 2200, desde, hasta),
            new ActividadCurso("spoiler", "No way", 0, desde, hasta),};
    ...
    public ResponseEntity<InputStreamResource>  actividadTodosLosCursosImage(
        ...
        InputStream in = ControlActividadApplication
    ...
    public String actividadTodosLosCursosCSV(
            ...
            @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") ZonedDateTime desde,
            @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") ZonedDateTime hasta) {
        if (desde == null) desde = ZonedDateTime.of(2016, 6, 1, 0, 0, 0, 0, ZoneId.of("UTC+0"));
        if (hasta == null) hasta = ZonedDateTime.of(2042, 12, 31, 0, 0, 0, 0, ZoneId.of("UTC+0"));
    ...
    /*
    @GetMapping(path = "/{codigo}/actividad",
            produces = {MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_XML_VALUE})
    public List<ActividadCurso> actividadCurso(
