[[resources-actividad-unico-curso]]
== Actividad Único Curso

[[resources-actividad-unico-curso-get]]
=== Obtener un curso (JSON/XML)
...
include::{snippets}/actividad-unico-curso/get-actividad-json/request-fields.adoc[]
